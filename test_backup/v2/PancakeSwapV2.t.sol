...
import { ICatalistV2Factory } from '../../src/modules/huskey/v2/interfaces/ICatalistV2Factory.sol';
import { ICatalistV2Pair } from '../../src/modules/catalist/v2/interfaces/ICatalistV2Pair.sol';
import { Constants } from '../../src/libraries/Constants.sol';
import { Commands } from '../../src/libraries/Commands.sol';
import { RouterParameters } from '../../src/base/RouterImmutables.sol';

abstract contract CatalistSwapV2Test is Test, GasSnapshot {
  address constant RECIPIENT = address(10);
  uint256 constant AMOUNT = 1 ether;
  uint256 constant BALANCE = 100000 ether;
  ICatalistV2Factory constant FACTORY =
    ICatalistV2Factory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73);
  ...
  function setUp() public {
    ...
    RouterParameters memory params = RouterParameters({
      ...
      v2InitCodeHash: bytes32(
        0x31d4d4735f7b385a73bf8f4f40ce20074534e8112c1ff3324a1c032a2a17f021
      ),
  ...
  function test_v2Swap_exactInput0For1() public {
    ...
    snapLastCall('CatalistSwapV2Test#test_v2Swap_exactInput0For1');
  ...
  function test_v2Swap_exactOutput0For1() public {
    ...
    router.execute(commands, inputs);
    snapLastCall('CatalistSwapV2Test#test_v2Swap_exactOutput0For1');
