...
contract DeployHashkey is DeployUniversalRouter {
  ...
  function getDeploymentSalt() public pure override returns (bytes32) {
    return keccak256('HUK-V4-UNIVERSAL-ROUTER/UniversalRouter/0115-003');
  }
  ...
  function setUp() public override {
    params = RouterParameters({
      ...
      v2Factory: 0x89cA51f192D8Ee643Cb0552B45448BD4b3b114d3,
      ...
      v3NFTPositionManager: 0x49A5B1A60dF367D40Df907E715Db1A54c67B3a2e,
