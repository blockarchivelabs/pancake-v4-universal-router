...
// Copyright (C) 2024 HuskeySwap
pragma solidity ^0.8.0;

import {ActionConstants} from "pancake-v4-periphery/src/libraries/ActionConstants.sol";
import {SafeCast} from "./SafeCast.sol";
import {IHuskeyV3Pool} from "./interfaces/IHuskeyV3Pool.sol";
import {IHuskeyV3SwapCallback} from "./interfaces/IHuskeyV3SwapCallback.sol";
...
/// @title Router for HuskeySwap v3 Trades
abstract contract V3SwapRouter is
    RouterImmutables,
    Permit2Payments,
    IHuskeyV3SwapCallback
{
    ...
    /// @notice Performs a HuskeySwap v3 exact input swap
    ...
    /// @notice Performs a HuskeySwap v3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        emit PoolParam(tokenIn, fee, tokenOut);
        ...
        (amount0Delta, amount1Delta) = IHuskeyV3Pool(
            UniversalRouterHelper.computePoolAddress(
                PANCAKESWAP_V3_DEPLOYER,
                PANCAKESWAP_V3_POOL_INIT_CODE_HASH,
                tokenIn,
